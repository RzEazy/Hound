...
class SafetyChecker:
    ...
    def is_osquery_sql_safe(self, sql: str) -> Tuple[bool, str]:
        ...
        # Check for union injections (only block if it looks like injection via user input,
        # not legitimate UNION ALL queries generated by the system)
        # Disabled for autonomous hunting - UNION is valid osquery syntax
